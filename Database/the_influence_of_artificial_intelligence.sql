...
--
-- Database: `the_influence_of_artificial_intelligence`
--
CREATE DATABASE IF NOT EXISTS `the_influence_of_artificial_intelligence` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `the_influence_of_artificial_intelligence`;
...
INSERT INTO `django_migrations` (`id
...
('bnsqqie6z4atjh8xqjmym9rsi9riowu4', 'eyJ1c2VyaWQiOjF9:1qsh28:6vWpnOkoF7TApiRoi479T7ksJWibPSmLuWSlXVpgxVo', '2023-10-31 10:10:40.350292'),
...
('t5daiymch3gc6obtyms2nop70txmmwk3', 'eyJ1c2VyaWQiOjJ9:1qsiKs:Q2_EcvQvwHDo-fE0MVl6k_5PdkkOYI8cAEbOKSLXJ1M', '2023-10-31 11:34:06.750059'),
...
(1, 'Kadhir', 'Kadhir123@gmail.com', 'Kadhir', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
CREATE TABLE IF NOT EXISTS `remote_user_cyber_attack_detection` (
  ...
  `Source_IP_Address` varchar(300) NOT NULL,
  `Destination_IP_Address` varchar(300) NOT NULL,
  `Source_Port` varchar(300) NOT NULL,
  `Destination_Port` varchar(300) NOT NULL,
  `Protocol` varchar(300) NOT NULL,
  `Packet_Length` varchar(300) NOT NULL,
  `Packet_Type` varchar(300) NOT NULL,
  `Traffic_Type` varchar(300) NOT NULL,
  `Payload_Data` varchar(300) NOT NULL,
  `Malware_Indicators` varchar(300) NOT NULL,
  `Anomaly_Scores` varchar(300) NOT NULL,
  `Alerts_Warnings` varchar(300) NOT NULL,
  `Attack_Signature` varchar(300) NOT NULL,
  `Action_Taken` varchar(300) NOT NULL,
  `Severity_Level` varchar(300) NOT NULL,
  `Device_Information` varchar(300) NOT NULL,
  `Network_Segment` varchar(300) NOT NULL,
  `Geo_City_location_Data` varchar(300) NOT NULL,
  `Proxy_Information` varchar(300) NOT NULL,
  `Firewall_Logs` varchar(300) NOT NULL,
  `IDS_IPS_Alerts` varchar(300) NOT NULL,
  `Log_Source` varchar(300) NOT NULL,
...
INSERT INTO `remote_user_cyber_attack_detection` (`id`, `Fid`, `Timestamp`, `Source_IP_Address`, `Destination_IP_Address`, `Source_Port`, `Destination_Port`, `Protocol`, `Packet_Length`, `Packet_Type`, `Traffic_Type`, `Payload_Data`, `Malware_Indicators`, `Anomaly_Scores`, `Alerts_Warnings`, `Attack_Signature`, `Action_Taken`, `Severity_Level`, `Device_Information`, `Network_Segment`, `Geo_City_location_Data`, `Proxy_Information`, `Firewall_Logs`, `IDS_IPS_Alerts`, `Log_Source`, `Prediction`) VALUES
(2, '172.217.9.238-10.42.0.151-443-55643-6', '12-02-23 7:13', '11.48.99.245', '178.157.14.116', '34489', '20396', 'ICMP', '1022', 'Data', 'DNS', '"Amet libero optio quidem praesentium libero. Ea magnam atque corporis ipsum iure iusto. Eveniet dolor odio libero. Minus iste fugit asperiores minima eos ipsum."', 'IoC Detected', '54.05', 'Alert Triggered', 'Known Pattern A', 'Logged', 'High', 'Mozilla/5.0 (Macintosh; U; PPC Mac OS X 10_7_6) AppleWebKit/534.2 (KHTML, like Gecko) Chrome/45.0.865.0 Safari/534.2', 'Segment A', 'Phagwara, Andhra Pradesh', '192.31.159.5', 'Log Data', 'Alert Data', 'Firewall', 'Intrusion'),
(3, '172.217.10.66-10.42.0.151-443-57121-6', '13-11-22 8:23', '63.79.210.48', '198.219.82.17', '16811', '53600', 'UDP', '306', 'Control', 'HTTP', 'Perferendis sapiente vitae soluta. Hic delectus quae nemo ea esse est rerum.', 'IoC Detected', '87.42', 'Alert Triggered', 'Known Pattern B', 'Ignored', 'Low', 'Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.2; Trident/5.0)', 'Segment C', 'Bokaro, Rajasthan', '114.133.48.179', 'Log Data', 'Alert Data', 'Firewall', 'DDoS'),
(4, '202.77.129.150-10.42.0.211-80-37124-6', '26-04-22 14:58', '139.195.148.49', '193.199.239.126', '16307', '12755', 'ICMP', '354', 'Control', 'HTTP', '"Ullam omnis qui. Dicta eum eos qui repudiandae eveniet. Ex eius ipsam rem. Possimus a quam consectetur est. Illo iusto dolor accusamus magnam harum qui."', 'NA', '10.59', 'Alert Triggered', 'Known Pattern A', 'Ignored', 'Low', 'Opera/9.12.(X11; Linux i686; id-ID) Presto/2.9.176 Version/12.00', 'Segment C', 'Dehradun, Tamil Nadu', 'NA', 'NA', 'Alert Data', 'Server', 'DDoS');
...
(77, 'Artificial Neural Network (ANN)', '34.100974313551816'),
(78, 'SVM', '33.12666076173605'),
(79, 'Logistic Regression', '33.03808680248007'),
(80, 'Decision Tree Classifier', '34.720992028343666'),
(81, 'Gradient Boosting Classifier', '32.772364924712136');
...
(10, 'DDoS', '66.66666666666666'),
(11, 'Intrusion', '33.33333333333333');
